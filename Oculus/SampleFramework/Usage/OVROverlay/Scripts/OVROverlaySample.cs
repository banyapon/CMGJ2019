...
namespace OculusSampleFramework
{
    ...
    public class OVROverlaySample : MonoBehaviour
    {
        ...
        void Start()
        {
            DebugUIBuilder.instance.AddLabel("After Breakup VR");
            DebugUIBuilder.instance.AddDivider();
            DebugUIBuilder.instance.AddLabel(" ");
            DebugUIBuilder.instance.AddButton("Start Game", TriggerLoad);
            DebugUIBuilder.instance.AddButton("About Us", TriggerUnload);
            DebugUIBuilder.instance.AddDivider();
            DebugUIBuilder.instance.AddLabel("Chiang Mai Game Jam 2019");
